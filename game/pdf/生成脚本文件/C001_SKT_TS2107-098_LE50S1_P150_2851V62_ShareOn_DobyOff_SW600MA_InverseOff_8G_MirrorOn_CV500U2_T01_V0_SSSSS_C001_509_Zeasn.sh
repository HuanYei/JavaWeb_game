...
pcb_board_type=Toptech_PCB_BOARD_P150_2851V62
config_pcb_varient=Toptech_PCB_BOARD_P150_2851V62

# string, customer short name
cus_id="C001"
# string, product full name
# this value will include into OTA package name
cus_pro_id="LE50S1_P150_2851V62_TS2107-098"
# string, software revision
software_revision="V1.0.01"
# string pcb name
pcbname="P150_2851V62"
...
#customer_folder
customer_folder=$toptech_path/customer/$cus_id/TS2107-098_TURKEY_LE50S1_P150_2851V62_CV500U2_T01_V0_CX509_SSSSS
...
bootlogo_file=bootlogo_C001_SSSSS

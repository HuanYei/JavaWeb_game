...
# Product Device Name
customer_device_name="Android_Smart_Ekran"
# Product Model Name
customer_model_name="Android_Smart_Ekran"
...
pcb_board_type=Toptech_PCB_BOARD_P50_368_V50
config_pcb_varient=Toptech_PCB_BOARD_P50_368_V50

# string, customer short name
cus_id="C001"
# string, product full name
# this value will include into OTA package name
cus_pro_id="LE32S1_P50_368_V50_TZ2109-108"
...
#customer_folder
customer_folder=$toptech_path/customer/$cus_id/TZ2109-108_TURKEY_LE32S1_P50_368_V50_V320BJ8_Q01C1_CX509_NAVITECH
...
bootlogo_file=bootlogo_C001_NAVITECH
...
preinstall_apk="ZeasnApp_NAT EShare GMS IPTV"
remove_apk="ZeasnApp"

#ota info

#####zeasn properties start
zeasn_devicetype=TopTechMTK368_NAT

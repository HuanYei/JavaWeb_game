...
#customer_folder
customer_folder=$toptech_path/customer/$cus_id/TZ2108-032_NEPAL_LE32V2_EL_MT9255_FA48_V320BJ8_Q01C1_CX616_AURA
...
bootlogo_file=bootlogo_C001_AURA
...
#es_CO vi_VN
language_list="en_US fr_FR ar_EG es_ES pt_PT"
